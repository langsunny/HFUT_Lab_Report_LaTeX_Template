...
\begin{titlepage}
\center{\erhao{\hwxk{合肥工业大学 \underline{仪器科学与光电工程}学院}}}
\vspace{6cm}
...
(这部分需要详细填写实验内容。软硬件设计图，流程图，关键内容。原则上字数不少于1000字。)\\
...
(自行填写。必须写点什么，调试过程、现象、遇到的问题和解决方法等，不能copy，不能写“无”)\\
...
\bottomcaption{\xiaowuhao{合肥工业大学}}
\end{figure}
